...
use meshcore_companion_rs::commands::{AdvertisementMode, DeviceQuery, GetContacts, RadioParameters, SendChannelTxtMsg};
use meshcore_companion_rs::consts;
use meshcore_companion_rs::consts::USA_RADIO_PRESET;
